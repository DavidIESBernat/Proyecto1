      ...
      <a href="<?php $url?>?controlador=producto&accion=carta" class="col-12 col-md-6 row no-margin-row element">
        ...
        <div class="col-12 col-md-3 element-text d-flex justify-content-between">
          ...
          <div class="button-discover">
            <p class="d-flex align-items-center">Descubrir <svg width="15" id="arrow_svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="m31.71 15.29-10-10-1.42 1.42 8.3 8.29H0v2h28.59l-8.29 8.29 1.41 1.41 10-10a1 1 0 0 0 0-1.41z" data-name="3-Arrow Right" fill="#e61414"/></svg></p>
          </div>
        </div>
      </a>
      <!--Elemento Calendario-->
